...
public interface RoleUserService extends BaseService<CfgUmsRoleUser> {

	/**
	 * 
	 * @Title: findByUserId
	 * @Description: (根据用户ID查询是否已分配角色)
	 * @param userId
	 * @return
	...
	/**
	 * 
	 * @Title: getCurrentUserRight
	 * @Description: (获取当前用户拥有的所有权限)
	 * @return
	...
	List<String> getCurrentUserRightWithRedis();
