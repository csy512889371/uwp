...
function fileQueued(file) {
    ...
    this.customSettings.upload_target = divfileId;
    this.startUpload();
}
...
function addReadyFileInfo(fileId, fileUrl, message, status) {
    ...
    var btmHtml = "<div id=\"swfu_ldr-" + fileId + "-oper\" class=\"_op\"><div class=\"_btnwrp\"><div class=\"_btn\"><a  href='javascript:deleteFile(\"" + fileId + "\")'>删除</a></div>";
    var titleHtml = '<div id="swfu_ldr-' + fileId + '-lk" class="_tit fix" style="min-width:135px;max-width:200px" title="' + fileName + '"><a class="fileLink"  status=' + status + '  href="' + fileUrl + '" onclick="">' + fileName + '</a></div>';
...
function deleteFile(fileId) {
    ...
    try {
        ...
        fileName = fileName.substring(fileName.lastIndexOf("/reasource")+10);
    }
    catch (e){
        row.remove();
        return;
