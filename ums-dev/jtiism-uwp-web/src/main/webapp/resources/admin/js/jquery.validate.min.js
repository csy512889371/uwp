...
(function(t) {
    ...
    t.extend(t.validator, {
        ...
        messages: {
            ...
            rangelength: t.validator.format("请输入 一个长度介于{0}和{1}之间的字符串！"),
        ...
        prototype: {
            init: function() {
                ...
                t(this.currentForm).validateDelegate(":text, [type='password'],[type='mobile'],[type='spachar'], [type='file'], select, textarea, [type='number'], [type='search'] ,[type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'] ", "focusin focusout keyup", e).validateDelegate("[type='radio'], [type='checkbox'], select, option", "click", e),
        ...
        methods: {
            ...
            mobile: function(t, e){
            	...
            	return this.optional(e) || (mobile.test(t));
            },
            spachar: function(t,e){
            	var spachar = /^[\u4e00-\u9fa5_a-zA-Z0-9]+$/;
        		return this.optional(e) || (spachar.test(t));
            },
