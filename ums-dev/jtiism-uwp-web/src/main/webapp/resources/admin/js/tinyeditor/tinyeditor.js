...
TINY.editor = function() {
	...
	function edit(n, obj) {
		...
		if (obj.editAble) {
			...
			this.d = 1;
			this.e.onkeydown =tinykeydown;
		} else {
			this.e.onkeydown = function(e) {
				var currKey = 0, e = e || this.parentWindow.event;
			...
			this.e.body.style.backgroundColor = '#EEE';
			this.d = 0;
		}
	...
	;
			edit.prototype.openEdit = function() {
				this.e.body.style.backgroundColor = '#FFF';
				this.e.designMode = 'On';
				this.d = 1;
				this.e.onkeydown =tinykeydown;
			},
			edit.prototype.stopEdit = function() {
				this.e.body.style.backgroundColor = '#EEE';
				this.e.onkeydown = function(e) {
					var currKey = 0, e = e ||this.parentWindow.event;
					currKey = e.keyCode || e.which || e.charCode;
			...
			edit.prototype.smartMenu= function(menuData,option){
				option["thisI"]=this.e;
				this.obj.menuData=menuData;
				this.obj.menuOption=option;
				$(this.e).smartMenu(menuData,option);
			}
			edit.prototype.setValue = function(val) {
				...
				var m = '<html><head>', bodyid = this.obj.bodyid ? " id=\"" + this.obj.bodyid
						+ "\"" : "";
				if (this.obj.cssfile) {
					m += '<link rel="stylesheet" href="' + this.obj.cssfile + '" />'
				}
				if (this.obj.css) {
					m += '<style type="text/css">' + this.obj.css + '</style>'
				}
				m += '</head><body ' + bodyid + '>' + val;
				m += '</body></html>';
				this.e.write(m);
				this.e.close();
			//	$(this.e).smartMenu(this.obj.menuData,this.obj.menuOption);
				this.e.onkeydown = tinykeydown;
				$(this.e).each(function() {
					this.oncontextmenu = function(e) {
						return false;
			...
			function tinykeydown(e){
				var currKey = 0, e = e ||this.parentWindow.event;
				currKey = e.keyCode || e.which || e.charCode;
				if (e.ctrlKey&&currKey==86) {
					 var str1=window.clipboardData.getData("text"); 
					 window.clipboardData.setData("text",str1);
					 setTimeout("dealData()",70);
				}
				return true;
			};
