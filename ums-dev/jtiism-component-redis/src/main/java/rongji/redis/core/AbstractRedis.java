...
import rongji.redis.core.utils.ObjectUtils;

/**
 * User:cxtww Date:2016年11月4日 上午11:46:15 Version:1.0
 */
public abstract class AbstractRedis {
	...
	public boolean canNotUse(boolean isNeedRedis) {
		return redisService.canNotUse(isNeedRedis);
	}
}
