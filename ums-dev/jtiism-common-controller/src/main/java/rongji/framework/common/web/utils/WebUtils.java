package rongji.framework.common.web.utils;
...
public final class WebUtils {
	...
	/**
	 * 返回WebApp class 的物理地址，即使类被打倒Jar包中,也可行
	 * @return
	 */
	public static String getWebAppClassPath(){
		String path = Thread.currentThread().getContextClassLoader().getResource("").getPath();
		logger.debug("getWebAppClassPath path: " + path);
		return path;
	}
	...
	public static String getWebAppPath(){
		...
		logger.debug("getWebAppPath path: " + path);
		return path;
	}
